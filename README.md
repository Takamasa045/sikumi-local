...
- 里山と工房の見た目を選べる。届いた Zip を設定から入れると、その見た目も選べる
...
届いた庭の Zip は、設定の「Packを確認して追加」から入れます。入手元は Zip、場所は Zip のパスです。確認して導入すると、庭の「里山 / 工房」の横にその見た目が出ます。Zip の中身の作り方は [examples/packs/example-garden](examples/packs/example-garden) です。
